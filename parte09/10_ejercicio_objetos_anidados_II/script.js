let letraNombre = {
  ...
  let fecha = prompt("Fecha de nacimiento con puntos");
  let nombre = prompt("Nombre en minusculas");
  let apellido = prompt("Apellido");
  
  let primeranombre = nombre.charAt(0);
  let ultimaapellido = apellido.substring(apellido.length - 1, apellido.length);
  let ultimafecha = fecha.substring(fecha.length - 1, fecha.length);
  
  console.log(letraNombre[primeranombre]);
  console.log(letraApellido[ultimaapellido]);
  console.log(fechaNacimiento[ultimafecha]);